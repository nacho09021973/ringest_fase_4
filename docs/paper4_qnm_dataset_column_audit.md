...
The active Paper 4 producer was later renamed to `02c_paper4_literature_to_dataset.py` after schema/provenance fields were materialized. This audit still describes the initial outputs generated by the copied `02b_literature_to_dataset.py`.
